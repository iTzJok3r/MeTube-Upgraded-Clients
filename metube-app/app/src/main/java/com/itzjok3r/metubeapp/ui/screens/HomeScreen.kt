...
fun HomeScreen(
    ...
    onSubmit: (url: String, quality: String, type: String, format: String, codec: String) -> Unit
) {
    ...
    Column(
        ...
        // ── Submit Button ───────────────────────────────────────────────
        Button(
            onClick = { onSubmit(url, selectedQuality, selectedType, selectedFormat, selectedCodec) },
            modifier = Modifier
                .fillMaxWidth()
                .height(56.dp),
